...
var ServicesPage = /** @class */ (function () {
    function ServicesPage(apiService, loadingService, dataService, navController, alertService, callNumber, modalController) {
    ...
    ServicesPage.prototype.onCall = function () {
        this.callNumber.callNumber("+919870481482", true)
            .then(function (res) { return console.log('Launched dialer!', res); })
            .catch(function (err) { return console.log('Error launching dialer', err); });
    };
    ServicesPage.prototype.onChat = function (ev) {
    ...
    ServicesPage.prototype.info = function () {
    ...
    ServicesPage = __decorate([
        ...
        __metadata("design:paramtypes", [ApiService,
            ...
            DataService,
            NavController,
            AlertService, CallNumber, ModalController])
    ], ServicesPage);
    return ServicesPage;
}());
export { ServicesPage };
