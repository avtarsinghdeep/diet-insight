...
var PackagesPage = /** @class */ (function () {
    ...
    PackagesPage.prototype.ngOnInit = function () {
        ...
        this.apiService.userPackage(userId).subscribe(function (data) {
            if (data.status_code == 200) {
                ...
                if (_this.packages.break.status) {
                    _this.break_id = _this.packages.break.status == 2 ? '' : _this.packages.break.break_id;
                    _this.value = _this.packages.break.status == 2 ? false : true;
                }
                else {
                    _this.value = false;
                }
                if (_this.packages.break.status == 2) {
                    _this.current_status = 'On-Hold';
                }
                else {
                    _this.current_status = 'Active';
                }
            }
            else {
                _this.loadingService.dismiss();
    ...
    PackagesPage.prototype.onBreak = function (val) {
        var _this = this;
        ...
        this.loadingService.present();
        this.apiService.onBreak(userId).subscribe(function (data) {
            if (data.status_code == 200) {
                _this.loadingService.dismiss();
                _this.ngOnInit();
            }
    ...
    PackagesPage.prototype.upgradePackage = function (variation_id, duration_price_inr, duration_price_usd) {
        return __awaiter(this, void 0, void 0, function () {
            var payment_price, payment_price_usd, modal;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        payment_price = duration_price_inr - this.packages.current_package_amount;
                        payment_price_usd = duration_price_usd - this.packages.current_package_amount_usd;
                    ...
                    case 1:
                        ...
                        modal.onDidDismiss()
                            ...
                            if (data.data.role == "manual") {
                                _this.manual(data.data.role, variation_id, _this.packages.current_package_id, data.data.role, data.data.id, payment_price, payment_price_usd);
                            }
    ...
    PackagesPage.prototype.manual = function (value, variation_id, current_package_id, payment_mode, payment_id, payment_price, payment_price_usd) {
        return __awaiter(this, void 0, void 0, function () {
            var popover;
            var _this = this;
            return __generator(this, function (_a) {
    ...
    PackagesPage.prototype.customalert = function () {
    ...
    PackagesPage.prototype.successCall = function () {
        return __awaiter(this, void 0, void 0, function () {
            var popover;
            var _this = this;
            return __generator(this, function (_a) {
