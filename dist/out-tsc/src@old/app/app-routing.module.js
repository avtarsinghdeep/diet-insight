...
var routes = [
    ...
    { path: 'servicesSide', loadChildren: './services/services.module#ServicesPageModule', canActivate: [AuthGuard] },
    ...
    { path: 'myprofile', loadChildren: './myprofile/myprofile.module#MyprofilePageModule', canActivate: [AuthGuard] },
    { path: 'reschedule', loadChildren: './reschedule/reschedule.module#ReschedulePageModule' },
    { path: 'term-conditions', loadChildren: './term-conditions/term-conditions.module#TermConditionsPageModule' },
    ...
    { path: 'addmeal', loadChildren: './addmeal/addmeal.module#AddmealPageModule', canActivate: [AuthGuard] },
