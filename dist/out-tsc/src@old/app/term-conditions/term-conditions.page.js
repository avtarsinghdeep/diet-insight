...
var TermConditionsPage = /** @class */ (function () {
    function TermConditionsPage(navController, dataService) {
        ...
        this.terms = [{
            ...
            {
                condition: "Payments: You agree to make full payment at the start of the program."
            },
            {
                condition: "We do not guarantee 5, 10 or 15 kilo weight loss programs. We believe the human body can safely lose up to 2-3 kilos a month and we prefer to do it the right way, the holistic way and in a way that is safe for your body and in a way where the weight you lose will stay off and not bounce back once you get off the program."
            },
            {
                condition: "Upgrades: A program once enrolled in, can ONLY be upgraded within the first week from the start date. Downgrades are not allowed."
            },
            {
                condition: "Transfers: If, for a medical or other emergent reason, you are not able to continue the program, you can transfer it to a friend or a family member at the cost of consultation fee. No multiple transfers."
            },
            {
                condition: "Breaks: You can put your program on hold at any time and continue later at any time, provided you notify us prior to your scheduled appointments."
            },
            {
                condition: "Missed appointments: If you miss your appointment and do not notify us, it is your responsibility to reach out to us and reschedule your next appointment."
            },
            {
                condition: "Refunds: Once you have paid for a program, the No Refund policy applies. Due to the nature of services involved, no refund is provided, under any circumstances."
            }
        ];
    }
